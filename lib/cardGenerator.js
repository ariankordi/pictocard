...
// Reference dimensions at 1920px card height: text section 938px wide, font 61px.
...
async function generateCard({ imageBuffer, text, font, textColor, senderName, miiData, includeDate }) {
  ...
  // Font size scales with card height. At 1920px height, 61px font matches the original spec.
  ...
  if (miiData) {
    ...
    if (result) {
        const miiW = Math.round(270 * heightScale);
